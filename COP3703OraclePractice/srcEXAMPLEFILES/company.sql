...
(
    ...
    LINE_PRICE  NUMBER(7,2),
    constraint LINE_PK primary key (LINE_NUMBER, INV_NUMBER)
);
...
insert into PRODUCT
values ('WR3/TT3', 'Steel matting, 4''x8''x1/6", .5" mesh', to_date('17-JAN-02', 'DD-MON-YY'), 18, 5, 119.95, 0.10,
        25595);
select *
from product;
