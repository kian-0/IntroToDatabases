...
values ('John', 'Smith', 123456789, TO_DATE('1965-01-09', 'YYYY-MM-DD'), '731 Fondren, Houston TX', 'M', 30000,
        333445555, 5);
insert into employee
values ('Franklin', 'Wong', 333445555, TO_DATE('1955-12-08', 'YYYY-MM-DD'), '638 Voss, Houston TX', 'M', 40000,
        888665555, 5);
insert into employee
values ('Alicia', 'Zelaya', 999887777, TO_DATE('1968-01-19', 'YYYY-MM-DD'), '3321 Castle, Spring TX', 'F', 25000,
        987654321, 4);
insert into employee
values ('Jennifer', 'Wallace', 987654321, TO_DATE('1941-06-20', 'YYYY-MM-DD'), '291 Berry, Bellaire TX', 'F', 43000,
        888665555, 4);
insert into employee
values ('Ramesh', 'Narayan', 666884444, TO_DATE('1962-09-15', 'YYYY-MM-DD'), '975 Fire Oak, Humble TX', 'M', 38000,
        333445555, 5);
insert into employee
values ('Joyce', 'English', 453453453, TO_DATE('1972-07-31', 'YYYY-MM-DD'), '5631 Rice, Houston TX', 'F', 25000,
        333445555, 5);
insert into employee
values ('Ahmad', 'Jabbar', 987987987, TO_DATE('1969-03-29', 'YYYY-MM-DD'), '980 Dallas, Houston TX', 'M', 25000,
        987654321, 4);
insert into employee
values ('James', 'Borg', 888665555, TO_DATE('1937-11-10', 'YYYY-MM-DD'), '450 Stone, Houston TX', 'M', 55000, null, 1);
...
values (333445555, 'Alice', 'F', TO_DATE('1986-04-04', 'YYYY-MM-DD'), 'Daughter');
insert into dependent
